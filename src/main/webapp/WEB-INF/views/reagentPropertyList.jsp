...
<title>Item Property List- Synergy Inc</title>
					...
					<div class="col-md-12">
						...
						<div class="widget">
							...
							<div class="widget-head">
								<div class="pull-left">Item Property List</div>
							...
							<div class="widget-content">
								...
								<div class="table-responsive">
									...
									<c:if test="${!empty reagentProperties}">
										<table class="table table-striped" id="table1">
											...
											<tbody>
												<c:forEach items="${reagentProperties}" var="property"
													varStatus="tr">
													
													<tr >

														<td class="text-center">${tr.count}</td>
														<td class="text-left">${property.propertyName}</td>
														<td class="text-left">${property.modelNumber}</td>
														<td class="text-left">${property.installDate}</td>
														
														<td class="text-center"><a
															href="${pageContext.request.contextPath}/updateReagentProperty/${property.id}"><i
																class="fa fa-pencil-square-o" aria-hidden="true"
																title="Edit"></i></a> <a
															href="${pageContext.request.contextPath}/deleteReagentProperty/${property.id}"
															onclick="return archiveFunction('${pageContext.request.contextPath}/deleteReagentProperty/${property.id}')"><i
