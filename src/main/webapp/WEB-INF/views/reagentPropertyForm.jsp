...
<title>Item Property - Synergy Inc.</title>
...
<body>
	<!-- Page heading start -->
	<div class="page-head">
		<h2 class="pull-left" style="color: #428bca;">Item Property
			Form</h2>
					...
					<div class="widget-content">
						<div class="padd">
							...
							<form cssClass="form-horizontal" method="POST" name="reg"
								...
								action="${pageContext.request.contextPath}/addUpdateReagentProperty">


								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label class="col-lg-2 control-label">Property Name<span
												class="red">*</span>:
											</label>
											<div class="col-lg-5">
												<input id="propertyName" name="propertyName" type="text"
													<c:if test = "${!empty property.propertyName}"> value="${property.propertyName}" </c:if>
													class="form-control" />
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label class="col-lg-2 control-label">Model Number <span
												class="red">*</span>:
											</label>
											<div class="col-lg-5">
												<input id="modelNumber" name="modelNumber"
													<c:if test = "${!empty property.modelNumber}"> value="${property.modelNumber}" </c:if>
													class="form-control" />
											</div>
										</div>
									</div>
								...
								<div class="form-group">
									<c:choose>
										...
										<input type="hidden" name="propert_id" value="${property.id}">
