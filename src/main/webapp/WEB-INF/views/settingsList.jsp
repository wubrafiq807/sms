					...
					<div class="col-md-12">
						...
						<div class="widget">
							...
							<div class="widget-head">
								<div class="pull-left">Settings List</div>
										...
										<table class="table table-striped" id="table1">
											<thead>
												<tr style="background-color: #428bca; color: white">
													...
													<th class="text-center">Setting value</th>

													<th class="text-center">Action</th>
												</tr>
											</thead>
											<tbody>
												<c:forEach items="${settingList}" var="site" varStatus="tr">
													<tr>

														<td class="text-center">${tr.count}</td>
														<td class="text-center"><c:forEach var="list"
																items="${linstdata}" varStatus="loop">
																<c:if test="${loop.index==site.type-1}">
																${list}
																</c:if>
															</c:forEach> 
														...
														<td class="text-center"><a
															href="${pageContext.request.contextPath}/deletesetting/${site.id}"
															onclick="return archiveFunction('${pageContext.request.contextPath}/deletesetting/${site.id}')"><i
