...
public class CommonDaoImpl implements CommonDao {
	...
	public List getListByQuery(String sql) {
		try {
			Session session = sessionFactory.getCurrentSession();
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<Object> getObjectListByAnyColumnOrderByAscOrDscByLimit(
			String objectName,String orderBy, String orderedFormat,  int limit) {
		try {
			Session session = sessionFactory.getCurrentSession();
			Query query = session.createQuery("from " + objectName + " order by "
					+ orderBy + " " + orderedFormat);
	...
	public List<Object> getOneObjectByJoiningTwoObjectandWhere(String objectmain, String objectjoinable, String joinOnclumn,String joinOnclumn_value,
		...
		try {
			...
			Session session = sessionFactory.getCurrentSession();
			Query query = session.createQuery("from " + objectmain + " join "+objectjoinable+"  where " + joinOnObject +"."+joinOnclumn+"  = '" + joinOnclumn_value + "'");
